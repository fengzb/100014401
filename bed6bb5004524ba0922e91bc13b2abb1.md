...
然后基于[扩展点自适应机制][Link 1]，通过URL的“dubbo://”协议头识别，就会调用DubboProtocol的export()方法，打开服务端口20880，就可以把服务demoService暴露到20880端口了。
...
![8f98ef03078163adc8055b02ac4337a5.jpg][]
(图片来源：[https://dubbo.incubator.apache.org/docs/zh-cn/dev/sources/images/dubbo\_protocol\_header.jpg][https_dubbo.incubator.apache.org_docs_zh-cn_dev_sources_images_dubbo_protocol_header.jpg] ）
...
在Dubbo框架中，无论是服务提供者还是服务消费者，在执行服务调用的时候，都会经过Filter调用链拦截，来完成一些特定功能，比如监控数据埋点就是通过在Filter调用链上装备了MonitorFilter来实现的，详细的代码实现你可以参考[这里][Link 2]。

## 服务治理

服务治理手段包括节点管理、负载均衡、服务路由、服务容错等，下面这张图给出了Dubbo框架服务治理的具体实现。

![8d02991a1eac41596979d8e89f5344fc.jpg][]
...
![bff032fdcca1272bb0349286caad6c19.jpg][]
...
你可以按照Dubbo的[官方文档][Link 3]去安装并搭建一个服务化框架。如果想深入了解它的实现的话，可以下载[源码][Link 4]来阅读。
...
[Link 1]: http://dubbo.incubator.apache.org/zh-cn/docs/dev/SPI.html
[8f98ef03078163adc8055b02ac4337a5.jpg]: https://static001.geekbang.org/resource/image/8f/a5/8f98ef03078163adc8055b02ac4337a5.jpg
[https_dubbo.incubator.apache.org_docs_zh-cn_dev_sources_images_dubbo_protocol_header.jpg]: https://dubbo.incubator.apache.org/docs/zh-cn/dev/sources/images/dubbo_protocol_header.jpg
[Link 2]: https://github.com/apache/incubator-dubbo/blob/7a48fac84b14ac6a21c1bdfc5958705dd8dda84d/dubbo-monitor/dubbo-monitor-api/src/main/java/org/apache/dubbo/monitor/support/MonitorFilter.java
[8d02991a1eac41596979d8e89f5344fc.jpg]: https://static001.geekbang.org/resource/image/8d/fc/8d02991a1eac41596979d8e89f5344fc.jpg
[bff032fdcca1272bb0349286caad6c19.jpg]: https://static001.geekbang.org/resource/image/bf/19/bff032fdcca1272bb0349286caad6c19.jpg
[Link 3]: http://dubbo.incubator.apache.org/#/docs/user/quick-start.md?lang=zh-cn
[Link 4]: https://github.com/apache/incubator-dubbo
